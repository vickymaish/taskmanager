...
const HeaderTasks: React.FC<HeaderTasksProps> = ({ onSearchChange }) => {
  ...
  const openMenuHeaderHandler = () => dispatch(menusActions.openMenuHeader());
  const openMenuAccountHandler = () => dispatch(menusActions.openMenuAccount());
